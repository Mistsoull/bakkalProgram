...
class _CategoryRepository implements CategoryRepository {
  ...
  Future<PaginatedResponse<CategoryModel>> getCategories({
    ...
    final _options = _setStreamType<PaginatedResponse<CategoryModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late PaginatedResponse<CategoryModel> _value;
    try {
      _value = PaginatedResponse<CategoryModel>.fromJson(
        _result.data!,
