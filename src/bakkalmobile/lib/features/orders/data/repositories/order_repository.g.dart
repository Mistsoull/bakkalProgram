...
class _OrderRepository implements OrderRepository {
  ...
  Future<PaginatedResponse<OrderModel>> getOrders({
    ...
    final _options = _setStreamType<PaginatedResponse<OrderModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late PaginatedResponse<OrderModel> _value;
    try {
      _value = PaginatedResponse<OrderModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<OrderModel> markAsDelivered(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<OrderModel> markAsPaid(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
